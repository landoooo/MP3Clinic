...
public class ReportingDataBuilder {
	...
	public static final String DEFAULT_PROCESSOR_NAME = "processor name";
	...
	public static final Property<ReportingData,String> processorName = new Property<ReportingData,String>();
	...
	public static final Instantiator<ReportingData> ReportingData = new Instantiator<ReportingData>() {
		public ReportingData instantiate(PropertyLookup<ReportingData> lookup) {
			ReportingData reportingData = new ReportingData(
					...
					lookup.valueOf(processorName, DEFAULT_PROCESSOR_NAME));
